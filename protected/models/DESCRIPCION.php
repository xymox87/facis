 ...
 *
 * The followings are the available columns in table 'DESCRIPCION':
...
class DESCRIPCION extends CActiveRecord
{
	 ...
	 * @return DESCRIPCION the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('K_ID_DESCRIPCION, K_IDENTIFICADOR, K_ID_CREDITO', 'safe', 'on'=>'search'),
		);
	}
